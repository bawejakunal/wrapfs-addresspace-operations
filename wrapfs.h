...
struct wrapfs_options {
	unsigned char mmap;
	unsigned short debug;
};

extern struct wrapfs_options wopt;
...
extern int wrapfs_parse_options(char *options, struct wrapfs_options *wopt,
				bool remount); 
...
struct wrapfs_sb_info {
	...
	struct wrapfs_options mount_options;
};
